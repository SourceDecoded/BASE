BASE.require([
    ...
    BASE.data.dataStores.IndexedDbDataStore = function (Type, edm) {
        ...
        var flattenEntity = function (entity) {
            return Object.keys(model.properties).filter(function (propertyName) {
                return primitiveTypes.hasKey(model.properties[propertyName].type);
