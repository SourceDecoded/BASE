BASE.require([
    ...
    var role = BASE.data.testing.model.role;
    ...
    var hrAccountHasManyRoles = BASE.data.testing.relationships.hrAccountHasManyRoles;
    ...
    BASE.data.testing.Edm = function () {
        ...
        self.addOneToMany(hrAccountHasManyRoles);
