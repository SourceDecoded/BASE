    ...
    BASE.odata4.ODataVisitor = (function (Super) {
            ...
            self.getValue = function (key, value) {
                ...
                if (property) {
                    ...
                    if (property.type === Date || property.type === DateTimeOffset) {
                        ...
                        return formatLocalDateWithOffset(date);
        ...
        ODataVisitor.prototype["propertyAccess"] = function (left, property) {
            ...
            if (typeof left.value === "function") {
                ...
                return {
                    namespace: scope + (self.convertPropertiesToPascalCase ? property.toPascalCase() : property),
                    property: property
                };
                ...
                return {
                    namespace: left.namespace + "/" + (self.convertPropertiesToPascalCase ? property.toPascalCase() : property),
                    property: property
                };
